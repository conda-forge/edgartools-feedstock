...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/edgartools-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/edgartools-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install edgartools
```
...
It is possible to list all of the versions of `edgartools` available on your platform:
...
```
pixi search edgartools --channel conda-forge
```
